...
<style>
    .container-cous_Admin {
        margin: 20px;
        display: flex;
    }

    .container-cous_Admin ul {
    ...
    .cate_cous_Admin li :hover {
        background-color: #ccc;
    }

    .container-cous_Admin ul li {
        margin-right: 20px;
    }

    .container-cous_Admin ul li a {
        text-decoration: none;
        color: #333;
        font-weight: bold;
    }

    .container-cous_Admin ul li a:hover {
        color: #c00000;
    }

    .container-cous_Admin p {
        margin-top: 20px;
        font-size: 18px;
        color: #c00000;
        font-weight: bold;
            ...
            <div class="header__funtcion-full">
                <div class="header__funtcion">
                    <ul class="header__funtcion-list">
                        ...
                        <li class="header__funtcion-items"><a href="contact_User.php?category=contact" style=" color: #c00000;"><img src="pic_header/Contact.png">Quản lí liên hệ và tài khoản</a></li>
                    </ul>
                </div>
            </div>
        </header>

        <div class="container-cous_Admin">
            <div class="cate_cous_Admin">
                <ul>
                    <li>
                        <a href="contact_User.php?category=contact">Liên hệ</a>
                        <a href="contact_User.php?category=user">Tài khoản</a>
                    </li>
                </ul>
            </div>
            <div class="content_cous_Admin">
                <?php
