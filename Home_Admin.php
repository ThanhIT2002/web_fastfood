...
<style>
    .container-home_Admin {
    margin: 20px;
    display:flex
}

.container-home_Admin ul {
...
.cate_home_Admin li :hover {
    background-color: cccccc;
}
.container-home_Admin ul li {
    margin-right: 20px;
}

.container-home_Admin ul li a {
    text-decoration: none;
    color: #333;
    font-weight: bold;
}

.container-home_Admin ul li a:hover {
    color: #c00000;
}

.container-home_Admin p {
    margin-top: 20px;
    font-size: 18px;
    color: #c00000;
    font-weight: bold;
...
<body>
    ...
    <header class="header">
            ...
            <div class="header__funtcion-full">
                <div class="header__funtcion">
                    <ul class="header__funtcion-list">
                        <li class="header__funtcion-items"><a href="Home_Admin.php?category=banners" style=" color: #c00000;"><img src="pic_header/home.png">Quản lí trang chủ</a></li>
                        <li class="header__funtcion-items"><a href="menu_Admin.php?category=cart"><img src="pic_header/menu.png">Quản lí thực đơn</a></li>
        ...
        <div class="container-home_Admin">
           <div class="cate_home_Admin">
           <ul>
                <li>
                    <a href="?category=banners">Banners</a>
                    <a href="?category=category_product">Danh mục sản phẩm</a>
                </li>
            </ul>
           </div>
        <div class="content_home_Admin">
        <?php
    if (isset($_GET['category'])) {
        $category = $_GET['category'];
        if ($category == 'banners') {
            include 'displayBanners.php';
        } elseif ($category == 'category_product') {
            include 'displayCategoryProduct.php';
        }
    } else {
